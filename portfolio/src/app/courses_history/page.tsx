      ...
      <table className="hidden md:table min-w-full rounded-lg shadow-md ">
        ...
        <tbody>
          {sortedCourses.map((course) => (
            <tr
              key={course.title}
              className="border-b border-neutral-300/30 dark:border-neutral-700/30 hover:bg-neutral-300 dark:hover:bg-neutral-800 transition-colors duration-300"
            >
              ...
              <td className="p-3 text-sm text-secondary">
                <div className="flex flex-wrap gap-2">
                  {course.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="bg-emerald-500/10 dark:bg-emerald-300/10 text-emerald-800 dark:text-emerald-300 rounded-full text-sm px-3 py-1"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <td className="p-3 text-sm text-secondary font-semibold ">
                <Link
                  ...
                  target="_blank"
                  className="flex items-center gap-2 hover:text-emerald-800 hover:dark:text-emerald-300 transiction-colors duration-300"
      ...
      <table className="md:hidden min-w-full rounded-lg shadow-md">
        ...
        <tbody>
          {courses.map((course) => (
            <tr
              key={course.title}
              className="border-b border-neutral-300/30 dark:border-neutral-700/30 transition-colors duration-300"
            >
              <td className="p-3 text-sm text-secondary font-semibold">
                {course.title}
              </td>
