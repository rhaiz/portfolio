...
export const projects: Project[] = [
  {
    title: "Portfolio",
    description:
      "This is my personal portfolio website. It showcases my skills, projects, and experience as a software developer.",
  ...
  //   description:
  //     "Conversion of strings between different formats, such as snake_case, uppercase, and masked with asterisks (*). It provides a simple interface to convert strings easily.",
  ...
  // },
  {
    title: "BEWEAR",
    description:
      "BEWEAR is a web application of a online clothing store made in a bootcamp project. Used libraries such as shadcn/ui, React Hook Form e Zod for validations, BetterAuth for authentication and Drizzle as ORM.",
    technologies: [
      "React.js",
      "Next.js",
      "TypeScript",
    ...
    githubLink: "https://github.com/rhaiz/bewear-bootcamp",
    demoLink: "https://bewear-bootcamp-one.vercel.app/",
    imageLink: "/projects/bewear.png",
  },
];
